 ...
 * Generated on Sat, 04 Mar 2023 21:15:24 GMT
 */
...
export const boxShadowDefault = "5 5 5 3 #00000026, 4 4 5 6 #00000033";
export const typographyH1Bold = "Bold 48.829/110% Inter";
export const typographyH1Regular = "Regular 48.829/110% Inter";
export const typographyH2Bold = "Bold 39.063/110% Inter";
export const typographyH2Regular = "Regular 39.063/110% Inter";
export const typographyBody = "Regular 16/110% Roboto";
...
export const spacingMultiValue = "8 64px"; // You can have multiple values in a single spacing token. Read more on these: https://docs.tokens.studio/available-tokens/spacing-tokens#multi-value-spacing-tokens
export const borderRadiusSm = "4px";
export const borderRadiusLg = "8px";
export const borderRadiusXl = "16px";
export const borderRadiusMultiValue = "4 8px"; // You can have multiple values in a single radius token. Read more on these: https://docs.tokens.studio/available-tokens/border-radius-tokens#single--multiple-values
